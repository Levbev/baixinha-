...
<head>
  ...
  <title>Para Você, Baixinha 💖</title>
  <style>
    body {
      background: linear-gradient(to top right, #000000, #ff99cc);
      display: flex;
    ...
    .card {
      ...
      padding: 25px;
      border-radius: 25px;
      box-shadow: 0 8px 16px rgba(255,192,203,0.5);
      max-width: 400px;
    }
    .boneco {
      font-size: 70px;
